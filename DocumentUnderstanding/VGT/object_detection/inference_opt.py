...
def main():
    ...
    image_name = '1.tar_1401.0001.gz_infoingames_without_metric_arxiv_26_ori.jpg'

    output_root = 'D:/workspace_pdf/document_ai/AdvancedLiterateMachinery/DocumentUnderstanding/VGT/output/'
    image_root = 'D:/workspace_pdf/document_ai/AdvancedLiterateMachinery/DocumentUnderstanding/VGT/params/image_root/'
    grid_path = 'D:/workspace_pdf/document_ai/AdvancedLiterateMachinery/DocumentUnderstanding/VGT/params/grid_root/1.tar_1401.0001.gz_infoingames_without_metric_arxiv_26_ori.pkl'
    config_file = 'D:/workspace_pdf/document_ai/AdvancedLiterateMachinery/DocumentUnderstanding/VGT/object_detection/Configs/cascade/docbank_VGT_cascade_PTM.yaml'
    opts = ['MODEL.WEIGHTS', 'D:/workspace_pdf/document_ai/AdvancedLiterateMachinery/DocumentUnderstanding/VGT/weight/VGT_pretrain_model.pth']

    output_file_name = output_root + '【000039】_【中集集团】_2021年年度报告(8276k)_P282.png'
    ...
    cv2.imencode('.png', result_image)[1].tofile(output_file_name)
